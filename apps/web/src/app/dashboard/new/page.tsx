...
export default function NewPostPage() {
  ...
  const toolbarBtnClass =
    "p-3 rounded-lg bg-indigo-800/30 text-indigo-300/40 hover:text-indigo-200/80 hover:bg-indigo-500/30 transition-all cursor-pointer";

  return (
    <section className="w-full h-full">
      <Header
        heading="Create New Post"
        actions={[{ label: "Save", icon: Save , onClick: handleSaveDraft, isPending: saveDraft.isPending, loadingText: "Saving..." }]}
      />
            ...
            <div className="relative h-[88vh] bg-linear-to-tl from-black to-indigo-950/60 rounded-2xl border border-indigo-900/30 overflow-hidden">
              ...
              <div className="w-full h-full grid grid-cols-2 gap-0 overflow-hidden">
                ...
                <div className="relative w-full h-full overflow-hidden border-r border-indigo-900/30">
                  ...
                  <div className="flex items-center justify-between px-4 py-3 border-b border-indigo-900/30 bg-indigo-950/30">
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        ...
                        className="px-4 py-2 bg-linear-to-tl to-indigo-900 text-sm text-white/70 hover:text-white/90 transition-colors cursor-pointer"
                      >
                        Clear
                      </Button>
                      <Button
                        onClick={() => handlePost()}
                        className="flex items-center gap-2 px-6 py-2.5 bg-linear-to-tl from-indigo-900 via-indigo-900 to-indigo-800 hover:to-indigo-700 hover:via-indigo-700 text-white rounded-lg font-medium ease-in-out duration-200 cursor-pointer"
                      >
                  ...
                  {/* Editor Area */}
                  <div className="p-4 h-[calc(100%-56px)] bg-indigo-500/20 overflow-y-auto">
                    <Tiptap
                      ref={tiptapRef}
